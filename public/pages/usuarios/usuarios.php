...
<body>
    ...
    <div class="principalBox container">
        ...
        <div class="col-12">
            <button class="btn btn-success" onclick="buscarTodosUsuarios().buscar()"><i class="fas fa-search"></i>&nbsp;&nbsp;ATUALIZAR</button>
    ...
    <script src="../../javascript/usuarios/buscarTodosUsuarios.js"></script>
    <script src="../../javascript/usuarios/inativarUsuario.js"></script>
